...
public class StepsforInsurance extends commonbase{
	...
	@When("User provides correct car Insurance Details")
	public void user_provides_correct_car_insurance_details() throws InterruptedException {
		carinsu.clickMenu();
	...
	@Then("Gets the quotes")
	public void gets_the_quotes() throws InterruptedException, IOException {
		carinsu.EnterAnyName();
		carinsu.CorrectEmail();
		carinsu.mobinum();
		carinsu.clickEnterButton();
		carinsu.deliverydetails();
		carinsu.showroomprice();
		carinsu.submitbtn();
		carinsu.firstquote();
		getLogger().info("Getting Quotes for Car");
		carinsu.quotes();
	}
	@Then("User provides the incorrect mail")
	public void user_provides_the_incorrect_mail() throws InterruptedException, IOException {
		carinsu.NavigateBack();
		carinsu.clickMenu();
		carinsu.clickCarInsurance();
		carinsu.clickProceed();
		getLogger().info("Entering Car Details with Incorrect mail");
		carinsu.clickCityName();
		carinsu.clickRTO();
		carinsu.clickCarBrand();
		carinsu.clickCarModel();
